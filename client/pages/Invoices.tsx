  ...
  const invoices = [
    {
      ...
      customerAddress: "123 Solar St, Green City",
      amount: 2450,
      status: "paid",
      date: "2024-12-15",
      dueDate: "2024-12-30",
    ...
    },
    {
      ...
      customerAddress: "456 Business Ave, Eco Town",
      amount: 8900,
      status: "pending",
      date: "2024-12-14",
      dueDate: "2024-12-29",
      services: "Commercial Solar Array",
    },
    {
      id: "INV-003",
      customer: "Smith Solar Farm",
      customerAddress: "789 Farm Rd, Rural County",
      amount: 15200,
      status: "overdue",
      date: "2024-12-10",
      dueDate: "2024-12-25",
      services: "Large Scale Installation",
    },
    {
      id: "INV-004",
      customer: "Eco Home Solutions",
      customerAddress: "321 Green Ln, Sustainable City",
      amount: 3850,
      status: "paid",
      date: "2024-12-08",
      dueDate: "2024-12-23",
      services: "Residential Solar + Battery",
    },
    {
      id: "INV-005",
      customer: "TechCorp Headquarters",
      customerAddress: "555 Innovation Dr, Tech Park",
      amount: 12500,
      status: "pending",
      date: "2024-12-05",
      dueDate: "2024-12-20",
      services: "Roof Solar Installation",
    },
    {
      id: "INV-006",
      customer: "Davis Family Home",
      customerAddress: "888 Suburbia Rd, Hometown",
      amount: 4200,
      status: "draft",
      date: "2024-12-03",
      dueDate: "2024-12-18",
      services: "Solar Panel Maintenance",
    },
  ];
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="border-0 shadow-md bg-white/60 backdrop-blur-sm dark:bg-gray-800/60">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {Math.round((paidAmount / totalAmount) * 100)}% collected
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-md bg-white/60 backdrop-blur-sm dark:bg-gray-800/60">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {Math.round((pendingAmount / totalAmount) * 100)}% pending
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="border-0 shadow-md bg-white/60 backdrop-blur-sm dark:bg-gray-800/60 mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Manage all your solar service invoices
            </CardDescription>
          </CardHeader>
          <CardContent>
